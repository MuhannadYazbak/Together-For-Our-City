...
export default function READ(){
    ...
    return (
        <Space className="fullScreenStyle" direction="vertical">
            ...
            <p style={{width: '25vw', height: '25vh', backgroundColor: 'cyan', color: 'grey'}}>
               {assocs}
            </p>
            <Button className="buttonStyle" type="dashed" icon={<ArrowLeftOutlined/>} onClick={()=>{navigate(-1)}}>{t('Schedule.BACK')}</Button>
        </Space>
    )
}