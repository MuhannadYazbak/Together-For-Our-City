    ...
    <div className="register-container">
      ...
      >
        ...
        <Form.Item
          name="residence"
          label="Residence"
          rules={[{ required: true, message: "Please select your residence!" }]}
        >
          <AutoComplete
        ...
        >
          <Checkbox>
            I have read the{" "}
            <a href="#" onClick={handleAgreementClick}>
              agreement
            </a>
          </Checkbox>
        </Form.Item>
        ...
        >
          <p>
            Here's the agreement text. Lorem ipsum dolor sit amet, consectetur
            adipiscing elit. Nullam vel sapien libero.
          </p>
        </Modal>
